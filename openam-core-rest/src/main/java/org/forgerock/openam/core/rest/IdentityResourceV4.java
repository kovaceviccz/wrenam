...
public final class IdentityResourceV4 implements CollectionResourceProvider {
    ...
    /**
     * Gets an {@link IdentityDetails} object that represents the desired post‑update state of a group, based on the
    ...
    /**
     * Removes delegated “admin” privileges for users that were *removed* from a group update operation. The method
    ...
    /**
     * Creates a {@link ResourceResponse} with an opaque revision (version) derived from the supplied JSON content’s
     * hash code.
     */
    ...
    /**
     * Converts an {@link AMIdentity} representing a *group* into the JSON structure expected by the V4 REST API,
