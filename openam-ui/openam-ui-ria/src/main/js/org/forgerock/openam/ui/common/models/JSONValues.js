...
define([
    ...
    function ungroupCollectionProperties (raw, groupKey) {
        ...
        if (!_.isEmpty(nonGroupedProperties)) {
            console.warn(
                `Detected properties which do not belong to any group: [${nonGroupedProperties}]. ` +
    ...
    return class JSONValues {
        ...
        /**
         * Adds value for the provided property path. If a portion of path does not exist it's created.
         *
         * @param   {string|string[]} path Property path
         * @param   {string} value Value to be set
         * @returns {JSONValues} JSONValues object with new value set
         * @example
         * addValueForPath("one.two.three", "value");
         * addValueForPath(["one", "two", "three"], "value");
         */
        addValueForPath (path, value) {
        ...
        removeInheritance () {
            return new JSONValues(_.mapValues(this.raw, (property) => {
                return _.has(property, "inherited") ? property.value : property;
            }));
        }
        /**
