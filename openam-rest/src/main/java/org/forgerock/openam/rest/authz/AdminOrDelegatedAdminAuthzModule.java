...
public class AdminOrDelegatedAdminAuthzModule implements CrestAuthorizationModule {
    ...
    private static final String NAME = "AdminOrDelegatedAdminOnlyFilter";
    ...
    private Promise<AuthorizationResult, ResourceException> authorize(Context context) {
        try {
            ...
            if (RestUtils.isAdmin(context)) {
                debug.message(
                        "AdminOrDelegatedAdminAuthzModule :: User, {} accepted as Administrator or Delegated Administrator.",
                        userId);
                ...
                return newResultPromise(
                        AuthorizationResult.accessDenied("User is not an administrator or Delegated Administrator."));
            }
